...
<div class="container mt-3 m-border text-center">
    <h2>Welcome to PHP-DB Web : Pongphat</h2>
    <div class="d-grid gap-2">

        <a href="insertDataIndex.php" class="btn btn-success">FootBall Tickets</a>
        <a href="07_showData.php" class="btn btn-success">Show Data Table</a>
