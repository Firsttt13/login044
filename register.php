...
<body>
    <div class="login-container">
        <div class="login-image">
            <img src="img/oasis-be-here-now.webp" alt="Background image">
        </div>
        <div class="login-form">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="lname" id="lastnam" aria-describedby="lastname">
            </div>
            <div class="mb-3">
            ...
            <p style="text-align: center; margin-top: 20px;">Already has an acount <a href="login.php">Sign Up</a></p>
        </div>
    </div>
</body>
